...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: false,
		src: "", // Set an image path (relative to /src) before enabling. Relative to the /public directory if it starts with '/'
...
export const navBarConfig: NavBarConfig = {
	links: [
		LinkPreset.Home,
		LinkPreset.Archive,
		LinkPreset.Playlists,
		LinkPreset.About,
		{
			name: "GitHub",
			url: "https://github.com/necofuryai/necofuryai.dev", // Internal links should not include the base path, as it is automatically added
